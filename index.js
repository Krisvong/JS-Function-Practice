...
function goRight() {
    let secondAnswer = window.prompt('You come across a snoring dragon. On the other side of him, you see a shiny chest of treasure. Another path would lead you away from the dragon all together. Do you go past the dragon or away from the dragon')
...
function continueOn () {
    let thirdAnswer = window.prompt('You come across a chamber that extends upward to a shining light above. There is a long, winding staircase and a much quicker, but rickety-looking, ladder that leads up towards the light. Which do you take, Ladder or Staircase?')
    if(thirdAnswer === 'ladder') {
        window.alert('After ascending a few feet up the ladder, one of its rungs snaps and you fall comedicaly through each of the rungs below. Sheepish, you return home.')
...
function pastTheDragon() {
    let thirdAnswer = window.prompt('The dragon awakes and sits upright. You only have a momennt to respond, to stay or to run. Do you stay or run?') 
    if(thirdAnswer === 'stay') {
